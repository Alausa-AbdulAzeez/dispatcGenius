...
const HeroText = () => {
  return (
    ...
    >
      <div className="font-bold text-[40px] text-[#797979] max-md:text-[30px] ">
        On-Demand Dispatch
      </div>
      <div className="font-bold text-[32px] underline text-light-blue max-md:text-[25px]">
        Anytime,{" "}
        <span className="italic no-underline text-[#1649EB]">Anywhere</span>
      </div>
      <div className="text-[20px] max-md:text-[14px] text-[#797979]">
