...
const HeroText = () => {
  return (
    ...
    >
      <div className="font-bold text-[40px]">On-Demand Dispatch</div>
      ...
      <div className="flex gap-5 mt-[30px] ">
        ...
        <Link to={"https://wa.me/+2348090987851"} target="_blank">
          <button className="bg-none px-[20px] py-[14px] text-white rounded-lg border border-white hover:bg-[#00F0FF] hover:border-[#00F0FF] hover:text-black transition-all duration-[3000] ease-in-out">
